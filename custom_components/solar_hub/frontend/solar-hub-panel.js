class SolarHubPanel extends HTMLElement {
  ...
  _settings() {
    ...
    return this._page("Settings", "Hardware discovered automatically from the inverter.",
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}.shell{max-width:1500px;margin:0 auto;padding:20px}
      ...
      .stats{display:grid;grid-template-columns:repeat(6,1fr);gap:12px;margin-top:14px}.detail{grid-template-columns:repeat(4,1fr)}.stat,.module,.rows{background:#0b1815;border:1px solid #1b302b;border-radius:18px;padding:18px}.stat span{display:block;color:#819a92;font-size:12px;font-weight:800}.stat strong{display:block;font-size:22px;margin:14px 0 4px}.stat small{color:#617a72}.module{display:flex;justify-content:space-between;gap:20px}.module span{color:#829b94}.rows{margin-top:14px}.row{display:flex;justify-content:space-between;gap:18px;padding:12px 0;border-top:1px solid #182a26}.row:first-child{border-top:0}.row span strong,.row span small{display:block}.row span small{color:#5f7770;font-size:10px;margin-top:3px}
